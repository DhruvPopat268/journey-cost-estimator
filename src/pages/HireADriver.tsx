      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
            Hire a Professional Driver in Bangalore – DriveGo
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
          {/* Why Choose DriveGo Drivers */}
          <div>
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Why Choose DriveGo Drivers?</h2>
        ...
        {/* How to Book Section */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 text-center mb-8">How to Book a Driver with DriveGo?</h2>
        ...
        <div className="bg-white rounded-lg shadow-md p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            We're just a call away. Whether it's an office drop, outstation trip, or night party, DriveGo ensures safety and convenience every time.
          </p>
